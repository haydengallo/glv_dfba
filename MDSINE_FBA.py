...
for key in subject_dict.keys():
    ...
    notes = 'Updating/fixing stability analysis to explicitly test for being in fixed point neighborhood 8/5/26 host at 1g , scale factor of 1e11, non scaled diet, stable timepoints, .001, .9 probability, explicitly add host fluxes to the output, upper bound of host is 0.5, not constrained to original met pool'
    use_glv_params = 'no'
