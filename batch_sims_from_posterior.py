...
### when transporting init_abun and time_steps from the run.py script, it is reencoded incorrectly us UTF-5 instead of float64 for some reason so need to figure that out 
init_abun = [.002, .002]
