...
### since we are on hpc need to explicitly set the gurobi lic environment variable 
...
data_dir = '/home/hayden.gallo-umw/DySCoMeMo_flux_sampling_sims/Venturelli_in_vitro/'
# directory for pan genus models 
cobra_models_dir_path = data_dir + '/data_input/panGenusModels_Venturelli_corrected'
...
plot_dir_path_base = '/home/hayden.gallo-umw/DySCoMeMo_flux_sampling_sims/Venturelli_in_vitro/' + test_name + '/test_' + str(test_num)
...
int_matrix = np.load('/home/hayden.gallo-umw/DySCoMeMo_flux_sampling_sims/Venturelli_in_vitro/data_input/int_matrix_reindexed_12_11_25.npy', allow_pickle=True)
...
growth_rates = np.load('/home/hayden.gallo-umw/DySCoMeMo_flux_sampling_sims/Venturelli_in_vitro/data_input/growth_rates_12_11_25.npy', allow_pickle=True)
...
m2_init_abun_path = data_dir + '/data_input/m2_time_series_init_no_mets.csv'
...
m2_final_abun_bac_path = data_dir + '/data_input/m2_time_series_final_no_mets.csv'
m2_final_abun_bac = pd.read_csv(m2_final_abun_bac_path, index_col = 0)

m2_final_abun_met_path = data_dir + '/data_input/m2_time_series_final_w_mets.csv'
...
multi_func_data = pd.read_csv('/home/hayden.gallo-umw/DySCoMeMo_flux_sampling_sims/Venturelli_in_vitro/data_input/2021_02_19_MultifunctionalDynamicData.csv', index_col = 0)
...
if multi_t_pt_dataset == 'yes':
    ...
    m2_init_abun = pd.read_csv('/home/hayden.gallo-umw/DySCoMeMo_flux_sampling_sims/Venturelli_in_vitro/data_input/multi_t_pt_for_glv_fba_init_vals_MDSINE2.csv', index_col=0)
    ...
    Venturelli_long_MDSINE2_interpolated_data = np.load('/home/hayden.gallo-umw/DySCoMeMo_flux_sampling_sims/Venturelli_in_vitro/data_input/Venturelli_long_MDSINE2_interpolated_data.npy', allow_pickle=True).item()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--sim-idx", type=int, default=None,
        help="0-based experiment index. If given, runs that one simulation "
    ...
    if cli_args.sim_idx is not None:
        ...
        sim_idx = cli_args.sim_idx
        if not (0 <= sim_idx < n_total):
            raise IndexError(f"sim_idx {sim_idx} out of range [0, {n_total})")
        ...
        print(f"[{spec_exp_name}] saved -> {result_path}")
