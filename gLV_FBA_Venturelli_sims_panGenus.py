...
test_num = 20
 ...
 ### Simulation notes
notes = 'Running all sims on desktop, not allowing uptake of but, succ, also think i solved the issue of having incorrect order of GEMs sometimes, also putting scaling factor to 50, maybe that will help'
