...
# Job and file paths
job_name = "sim"
#base_output_dir = "/home/hayden.gallo-umw/MDSINE_MC_constraints/Test_" + str(test_num)
#output_dir = "/home/hayden.gallo-umw/job_output/out_logs/MDSINE_MC_constraints/Test_" + str(test_num)
#os.makedirs(output_dir, exist_ok=True)
#error_dir = "/home/hayden.gallo-umw/job_output/error_logs/MDSINE_MC_constraints/Test_" + str(test_num)
#os.makedirs(error_dir, exist_ok=True)
#python_script_path = "/home/hayden.gallo-umw/glv_dfba_implement/glv_dfba/MDSINE_flux_sampling_hpc.py"

base_output_dir = "/home/hayden.gallo-umw/dyscomemo_in_vivo_flux_samp/Test_" + str(test_num)
output_dir = "/home/hayden.gallo-umw/dyscomemo_in_vivo_flux_samp/job_output/out_logs/Test_" + str(test_num)
os.makedirs(output_dir, exist_ok=True)
error_dir = "/home/hayden.gallo-umw/dyscomemo_in_vivo_flux_samp/job_output/error_logs/Test_" + str(test_num)
os.makedirs(error_dir, exist_ok=True)
python_script_path = "/home/hayden.gallo-umw/DySCoMeMo_master_branch/glv_dfba/in_vivo_flux_sampling_hpc.py"
