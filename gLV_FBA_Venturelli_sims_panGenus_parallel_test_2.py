...
if multi_t_pt_dataset == 'yes':
 ...
 ### Simulation notes
notes = 'trying to figure out how best to get bacteroides and dorea species to utilize acetate for growth in longitudinal sims, going to try with pFBA now'
