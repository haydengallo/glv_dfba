...
for key in subject_dict.keys():
    ...
    ### Simulation notes
    notes = 'running full sim with hourly for all 3 subjects...'
    ### Diet scaler
    ...
    init_mets_input_path = '/home/hayden.gallo-umw/MDSINE_Flux_Sampling/sub_' +  str(subject_to_predict) + '_met_df.tsv'
    ...
    RC_diet = pd.read_csv('/home/hayden.gallo-umw/MDSINE_Flux_Sampling/RC_mm_add.csv', header=None)
    ...
    taxonomy_path = '/home/hayden.gallo-umw/MDSINE_Flux_Sampling/taxonomy.tsv'
    ...
    RC_diet_adjusted = pd.read_csv('/home/hayden.gallo-umw/MDSINE_Flux_Sampling/RC_diet_adjust_mouse_GEM.csv')
    #RC_diet_adjusted
    ...
    plot_dir_path = '/home/hayden.gallo-umw/MDSINE_Flux_Sampling/flux_sampling_simulations/Test_' + str(test_num) + '/sim_' + str(sim_num) + '/Subject_' + str(subject_to_plot)
